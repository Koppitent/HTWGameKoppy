if instance_exists(ob_control) {
	...
	else if button_id=5 and ob_main.autoattack_toggle=false { draw_sprite_general(sp_sheet,0,16*29,16*(9+ceil(button_state)),16,16,x,y,1,1,0,c_white,c_white,c_white,c_white,1); }
	else if button_id=5 and ob_main.autoattack_toggle=true { draw_sprite_general(sp_sheet,0,16*30,16*(9+ceil(button_state)),16,16,x,y,1,1,0,c_white,c_white,c_white,c_white,1); }
	else if button_id=6 { draw_sprite_general(sp_sheet,0,16*32,16*(7+ceil(button_state)),16,16,x,y,1,1,0,c_white,c_white,c_white,c_white,1); }
}
