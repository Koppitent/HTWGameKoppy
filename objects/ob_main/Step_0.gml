...
type_chart=true or credits_screen=true or statistics_screen=true or help_screen=true or nickname_screen=true or ending_screen=true or textbox_string[textbox_current]!="" {
	cursor_hide=true;
...
//
if help_screen_toggle=true {
	help_screen=true;
	help_screen_toggle=false;
}
else if help_screen=true {
	...
	// Schließen mit Escape oder andere Tasten
	else if keyboard_check_pressed(vk_escape) or mouse_check_button_pressed(mb_right) {
		sc_playsound(sn_click,50,false,false);
		help_screen=false;
	}
}
...
if keyboard_check_pressed(vk_divide) {
	if cheat_show_stats=false { cheat_show_stats=true; }
	else { cheat_show_stats=false; }
}
//
