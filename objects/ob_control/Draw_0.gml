...
if card_draw_points>=card_drawcost_berry and card_berrydeck_total>0 {
	sc_drawrectangle(cam_x+19,cam_y+188,cam_x+58,cam_y+209,global.color_black,global.color_black,1,0.25,0.5,0);
	sc_drawtext(cam_x+39,cam_y+187,"Berry [A]",global.color_character_light,global.color_black,0.9,0.5,0,-1);
...
if card_draw_points>=card_drawcost_main and card_maindeck_total>0 {
	sc_drawrectangle(cam_x+cam_w-56,cam_y+188,cam_x+cam_w-21,cam_y+209,global.color_black,global.color_black,1,0.25,0.5,0);
	sc_drawtext(cam_x+cam_w-38,cam_y+187,"Main [D]",global.color_character_light,global.color_black,0.9,0.5,0,-1);
...
if card_focus!=-1 and card_focus.card_cat=0 and card_focus_hand!=-1 and card_hold=-1 {
	...
	for (var i=0; i<=4; i++;) {
		...
		if card_space_id[i].occupy_id!=-1 {
			...
			if sc_glyph_check(card_focus,ref_glyph_intimidate,true) { imaginary_penalty_atk+=1; } //glyph: intimidate
